...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="militrainingList" title="军事训练等级评定" actionUrl="militrainingController.do?datagrid" idField="id" fit="true">
   ...
   <t:dgCol title="负责人" field="head" width="100" align="center"></t:dgCol>
   <t:dgCol title="联系方式" field="phone" width="120" align="center"></t:dgCol>
   <t:dgCol title="创建时间" field="createTime" formatter="yyyy-MM-dd hh:mm:ss" width="130" align="center"></t:dgCol>
   <t:dgCol title="附件" field="fileId" downloadName="点击下载" width="100" align="center"></t:dgCol>
  </t:datagrid>
  </c:if>
   ...
   <t:dgCol title="创建时间" field="createTime" formatter="yyyy-MM-dd hh:mm:ss" width="130" align="center"></t:dgCol>
   <t:dgCol title="附件" field="fileId" downloadName="下载" url="fileId" funname="test(fileId)" align="center"></t:dgCol>
