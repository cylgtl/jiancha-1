...
<body id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      <!-- Breadcrumbs-->
      <ol class="breadcrumb">
        <li class="breadcrumb-item active">士兵选取</li>
          ...
          <div class="card mb-3">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" style="font-size: 12px;" cellspacing="0">
				<tr>
					...
					<td>
					${soldierSelectPage.name}
					</td>
					<td>
					性别：
					</td>
					<td>
					${soldierSelectPage.sex}
					</td>
				</tr>
				...
				<tr>
					...
					<td>
					<fmt:formatDate value='${soldierSelectPage.birthDay}' type="date" pattern="yyyy-MM-dd"/>
					...
					<td>
					${soldierSelectPage.politicalLandscape}
					</td>
				...
				<tr>
					...
					<td>
					${soldierSelectPage.nativePlace}
					</td>
					<td>
					民族：
					</td>
					<td>
					${soldierSelectPage.nationalName}
					</td>
				</tr>
				...
				<td>
					...
					<td>
					${soldierSelectPage.jobTitle}
					</td>
					<td>
					现军衔：
					</td>
					<td>
					${soldierSelectPage.nowRank}
					</td>
				...
				<tr>
					...
					<td>
					<fmt:formatDate value='${soldierSelectPage.rankTime}' type="date" pattern="yyyy-MM-dd"/>
				...
				<td>
					...
					<td>
					<fmt:formatDate value='${soldierSelectPage.militaryTime}' type="date" pattern="yyyy-MM-dd"/>
