...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="soldierSelectList" autoLoadData="true"  title="士官选取" actionUrl="soldierSelectController.do?datagrid&currentDepartId=${currentDepart.orgCode}" idField="id" fit="true">
