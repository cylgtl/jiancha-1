...
<script type="text/javascript">
	...
	function jubaoOnclickPerformances(){   
		createwindow('实时举报',
...
<div style="padding: 3px; height: 25px; width: width:1024px;" class="datagrid-toolbar">
	<a onclick="jubaoOnclickPerformances()" id="jubao" href="#" class="l-btn"><span class="l-btn-left"><span class="l-btn-text icon-add l-btn-icon-left">举报</span></span></a>
</div>
<table border="0" cellpadding="2" cellspacing="0" id="performances_table" style="width: 650px">
	<tr bgcolor="#E6E6E6">
