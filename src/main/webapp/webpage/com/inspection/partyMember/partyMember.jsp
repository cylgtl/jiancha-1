  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="partyMemberController.do?save">
			...
			<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
						<input class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  style="width: 150px" id="graduateTime" name="graduateTime" ignore="ignore"
				...
				<%-- <tr>
					...
					<td class="value">
						<input class="inputxt" id="graduateSchool" name="graduateSchool" ignore="ignore"
							   value="${partyMemberPage.graduateSchool}">
						<span class="Validform_checktip"></span>
					</td>
				</tr> --%>
			</table>
