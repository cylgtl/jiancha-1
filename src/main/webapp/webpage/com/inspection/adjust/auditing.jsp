		...
		$.each( $("#add_results_table").find("input:checked"), function( index, val ) {
			...
			$.ajax({
				//请求方式
				    type:'GET',
				    //发送请求的地址以及传输的数据
				    url:"adjustController.do?deleteAuditing&id="+id,
				    //服务器返回的数据类型
				    dataType:'json',
...
<table border="0" cellpadding="2" cellspacing="0" id="results_table" style="width: 900px">
	<tr bgcolor="#E6E6E6">
		<td align="center" bgcolor="#EEEEEE" style="text-align:center;width: 65px;">序号</td>
		<td align="center" bgcolor="#EEEEEE" style="width:120px;text-align:center;">开始时间</td>
		<td align="center" bgcolor="#EEEEEE" style="width:120px;text-align:center;">结束时间</td>
		<td align="center" bgcolor="#EEEEEE" style="width:150px;text-align:center;">单位</td>
		<td align="center" bgcolor="#EEEEEE" style="width:250px;text-align:center;">意见</td>
		<td align="center" bgcolor="#EEEEEE" style="width:100px;text-align:center;">附件</td>
	</tr>
<tbody id="add_results_table">
		<c:if test="${fn:length(lists)  <= 0 }">
			<tr>
				<td align="left"><input style="width: 55px;" type="checkbox" name="ck" /></td>
...
[${stuts.index }].compensateMinDays" maxlength="50" type="text"
				...
				<td align="left"><input   name="results[${stuts.index }].beginTime" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  style="width: 120px;height:30px"
							   value="<fmt:formatDate value='${auditing.beginTime}' type="date" pattern="yyyy-MM-dd"/>"></td>
				<td align="left"><input   name="results[${stuts.index }].endTime" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  style="width: 120px;height:30px"
							   value="<fmt:formatDate value='${auditing.endTime}' type="date" pattern="yyyy-MM-dd"/>"></td>
