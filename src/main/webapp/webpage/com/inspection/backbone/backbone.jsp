...
<html>
 ...
 <body style="overflow-y: hidden" scroll="no">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="backboneController.do?save">
			<input id="id" name="id" type="hidden" value="${backbonePage.id }">
			...
			<tr>
					...
					<td class="value" colspan="3">
						...
						<select name="backboneType" id="backboneType">
						    <option value="骨干配备">骨干配备</option>
						</select>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<input class="Wdate" onClick="WdatePicker()"  style="width: 150px" id="rankTime" name="rankTime" ignore="ignore"
							   value="<fmt:formatDate value='${backbonePage.rankTime}' type="date" pattern="yyyy-MM-dd"/>">
