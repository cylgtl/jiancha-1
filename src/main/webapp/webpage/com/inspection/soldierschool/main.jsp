...
<body style="overflow-y: hidden" scroll="no">
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table" action="soldierSchoolController.do?addorupdateOperate&id=${residuald}">
		<div style="width: 1024px; height: 500px"><%-- 增加一个div，用于调节页面大小，否则默认太小 --%>
	   	<div style="width:auto; height: 1px;"></div>
		<!--关联信息-->
		<t:tabs id="tt" iframe="false" tabPosition="top" fit="false">
			<t:tab href="soldierSchoolController.do?viewMyselfInfo&id=${residuald}" icon="icon-search" title="基本资料" id="1"></t:tab>
			<t:tab href="soldierSchoolController.do?viewResidualRecommend&id=${residuald}" icon="icon-search" title="民主评议/推荐" id="2"></t:tab>
			<t:tab href="soldierSchoolController.do?viewAuditing&id=${residuald}" icon="icon-search" title="各级研究意见和结果" id="3"></t:tab>
			<t:tab href="soldierSchoolController.do?viewPerformance&id=${residuald}" icon="icon-search" title="个人平时表现" id="4"></t:tab>
			<t:tab href="soldierSchoolController.do?viewAssessment&id=${residuald}" icon="icon-search" title="培训与考核结果" id="5"></t:tab>
		</t:tabs>
		</div>
	</t:formvalid>
