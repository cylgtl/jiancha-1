...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="soldierStudentList" autoLoadData="true"  title="大学毕业生士兵提干" actionUrl="soldierStudentController.do?datagrid&currentDepartId=${currentDepart.orgCode}" idField="id" fit="true">
  ...
  <div  style="padding: 3px; height: 40px">
    <div name="searchColums" style="float: left; padding-left: 15px;">
         ...
         <a href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="soldierStudentListsearch();" style="text-align: center;width: 140px">查询</a>
    </div>
</div>
 ...
 var admin = "${admin}";
	...
	function deleteConfirm(id,departId){
		if(admin || sessionDepartsCode.indexOf(departId) > -1){
			delObj('soldierStudentController.do?del&id='+id,'soldierStudentList');
		}else{
			alert("您没有权限处理其他连/科的数据");
		}
