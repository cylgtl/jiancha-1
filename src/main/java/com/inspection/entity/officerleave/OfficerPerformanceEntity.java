...
/**   
 * @Title: Entity
 * @Description: 军官请假个人表现信息
 * @author zhangdaihao
 * @date 2018-07-07 15:19:27
 * @version V1.0   
 *
 */
@Entity
@Table(name = "jc_officer_leave_performance", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class OfficerPerformanceEntity implements java.io.Serializable {
	/**主键*/
