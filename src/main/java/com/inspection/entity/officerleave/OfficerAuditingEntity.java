...
/**   
 * @Title: Entity
 * @Description: 军官请假上级意见详情
 * @author zhangdaihao
 * @date 2018-07-07 15:17:44
 * @version V1.0   
 *
 */
@Entity
@Table(name = "jc_officer_leave_audit", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class OfficerAuditingEntity implements java.io.Serializable {
	/**主键*/
