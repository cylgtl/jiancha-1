 ...
 * @Description: 骨干配备信息
 * @author zhangdaihao
 * @date 2018-07-10 14:24:57
 * @version V1.0   
 *
 */
@Entity
@Table(name = "jc_backbone", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class BackboneEntity implements java.io.Serializable {
	/**主键*/
	private java.lang.String id;
	/**骨干类型*/
	private java.lang.String backboneType;
	/**姓名*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  骨干类型
	 */
	@Column(name ="BACKBONE_TYPE",nullable=true,length=32)
	public java.lang.String getBackboneType(){
		return this.backboneType;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  骨干类型
	 */
	public void setBackboneType(java.lang.String backboneType){
	 ...
	 */
	@Column(name ="BANJI",nullable=true,length=64)
	public java.lang.String getBanji(){
		return this.banji;
	}
	 ...
	 */
	public void setBanji(java.lang.String banji){
		this.banji = banji;
	}
