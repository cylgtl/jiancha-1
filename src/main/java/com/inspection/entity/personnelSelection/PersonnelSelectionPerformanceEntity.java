...
/**   
 * @Title: Entity
 * @Description: 技术学兵选调  个人平时表现
 * @author zhangdaihao
 * @date 2018-07-09 15:09:24
 * @version V1.0   
 *
 */
@Entity
@Table(name = "jc_technical_personnel_selection_performance", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class PersonnelSelectionPerformanceEntity implements java.io.Serializable {
	/**主键*/
