...
/**   
 * @Title: Entity
 * @Description: 士兵考学 各级研究意见和结果
 * @author zhangdaihao
 * @date 2018-07-08 15:22:10
 * @version V1.0   
 *
 */
@Entity
@Table(name = "jc_soldiers_apply_audit", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class SoldiersApplyAuditEntity implements java.io.Serializable {
	/**主键*/
