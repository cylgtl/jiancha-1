...
/**   
 * @Title: Entity
 * @Description: 士兵考学  个人平时表现
 * @author zhangdaihao
 * @date 2018-07-08 15:32:00
 * @version V1.0   
 *
 */
@Entity
@Table(name = "jc_soldiers_apply_performance", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class SoldiersApplyPerformanceEntity implements java.io.Serializable {
	/**主键*/
