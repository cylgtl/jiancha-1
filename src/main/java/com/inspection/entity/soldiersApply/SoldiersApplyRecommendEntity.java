...
/**   
 * @Title: Entity
 * @Description: 士兵考学  民主评议/推荐
 * @author zhangdaihao
 * @date 2018-07-08 15:39:00
 * @version V1.0   
 *
 */
@Entity
@Table(name = "jc_soldiers_apply_recommend", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class SoldiersApplyRecommendEntity implements java.io.Serializable {
	/**推荐id*/
