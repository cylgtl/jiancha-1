 ...
 */
@Entity
@Table(name = "jc_cadres_adjust_recommend", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class AdjustRecommendEntity implements java.io.Serializable {
	/**推荐id*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  干部调整表关联ID
	 */
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  干部调整表关联ID
	 */
