 ...
 */
@Entity
@Table(name = "jc_cadres_adjust", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class AdjustEntity implements java.io.Serializable {
	/**id*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  调整类型
	 */
	@Column(name ="adjust_type",nullable=true,length=32)
