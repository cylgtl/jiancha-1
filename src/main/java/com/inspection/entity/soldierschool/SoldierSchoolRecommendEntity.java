 ...
 */
@Entity
@Table(name = "jc_soldier_school_recommend", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class SoldierSchoolRecommendEntity implements java.io.Serializable {
	/**推荐id*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  优秀士兵保送入学表关联ID
	 */
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  优秀士兵保送入学表关联ID
	 */
