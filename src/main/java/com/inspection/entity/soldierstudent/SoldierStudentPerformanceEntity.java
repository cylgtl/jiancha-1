 ...
 */
@Entity
@Table(name = "jc_soldier_student_performance", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class SoldierStudentPerformanceEntity implements java.io.Serializable {
	/**主键*/
