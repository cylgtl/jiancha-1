...
/**   
 * @Title: Entity
 * @Description: 大学生毕业生提干名主推荐信息
 * @author zhangdaihao
 * @date 2018-07-07 15:26:19
 * @version V1.0   
 *
 */
@Entity
@Table(name = "jc_soldier_student_recommend", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class SoldierStudentRecommendEntity implements java.io.Serializable {
	/**推荐id*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  大学生毕业生提干表关联ID
	 */
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  大学生毕业生提干表关联ID
	 */
