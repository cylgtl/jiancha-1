 ...
 */
@Entity
@Table(name = "jc_evaluation_residual_performance", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class EvaluationResidualPerformanceEntity implements java.io.Serializable {
	/**主键*/
