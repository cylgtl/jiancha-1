...
/**   
 * @Title: Entity
 * @Description: 表彰奖励上级意见
 * @author zhangdaihao
 * @date 2018-07-07 15:27:20
 * @version V1.0   
 *
 */
@Entity
@Table(name = "jc_commend_reward_audit", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class CommendRewardAuditEntity implements java.io.Serializable {
	/**主键*/
