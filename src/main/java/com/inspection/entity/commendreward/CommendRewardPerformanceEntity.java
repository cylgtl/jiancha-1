...
/**   
 * @Title: Entity
 * @Description: 表彰奖励个人表现信息
 * @author zhangdaihao
 * @date 2018-07-07 15:26:49
 * @version V1.0   
 *
 */
@Entity
@Table(name = "jc_commend_reward_performance", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class CommendRewardPerformanceEntity implements java.io.Serializable {
	/**主键*/
