...
/**   
 * @Title: Entity
 * @Description: 党员发展  民主评议/推荐
 * @author zhangdaihao
 * @date 2018-07-12 16:14:13
 * @version V1.0   
 *
 */
@Entity
@Table(name = "jc_party_member_recommend", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class PartyMemberRecommendEntity implements java.io.Serializable {
	/**推荐id*/
