...
/**   
 * @Title: Entity
 * @Description: 党员发展  考核结果
 * @author zhangdaihao
 * @date 2018-07-12 16:11:25
 * @version V1.0   
 *
 */
@Entity
@Table(name = "jc_party_member_assessment", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class PartyMemberAssessmentEntity implements java.io.Serializable {
	/**id*/
