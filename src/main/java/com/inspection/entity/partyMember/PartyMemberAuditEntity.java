...
/**   
 * @Title: Entity
 * @Description: 党员发展 各级研究意见和结果
 * @author zhangdaihao
 * @date 2018-07-12 16:12:23
 * @version V1.0   
 *
 */
@Entity
@Table(name = "jc_party_member_audit", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class PartyMemberAuditEntity implements java.io.Serializable {
	/**主键*/
