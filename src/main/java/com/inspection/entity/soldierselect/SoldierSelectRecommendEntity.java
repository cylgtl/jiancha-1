 ...
 */
@Entity
@Table(name = "jc_soldier_select_recommend", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class SoldierSelectRecommendEntity implements java.io.Serializable {
	/**推荐id*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  士兵选取表关联ID
	 */
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  士兵选取表关联ID
	 */
